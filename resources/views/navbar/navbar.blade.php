...
<nav class="navbar navbar-expand-lg bg-warning-subtle bg-opacity-10 border-bottom border-dark sticky-top">
    <div class="container-fluid">
      <a href="{{route('accueil.index')}}"><img style="height: 95px" src="../assets/img/logo.png" alt=""></a>
      ...
      <div class="collapse navbar-collapse " id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="{{route('accueil.index')}}">Accueil</a>
          </li>
